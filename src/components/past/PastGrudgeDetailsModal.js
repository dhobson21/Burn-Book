...
export default class PastGrudgeDetailsModal extends Component {
  ...
  render() {
    return (
      <Modal
        size="fullscreen"
        style={{ backgroundColor: "#5cdb95", borderRadius: 50 }}
        trigger={<Button color="grey">Details</Button>}
      >
        <Grid columns={4} divided padded textAlign="center">
          <Grid.Row>
            <Grid.Column>
              <Modal.Content>
                ...
                <Segment style={{ backgroundColor: "#5cdb95" }}>
                  <Header style={{ marginBottom: "5px" }} as="h4">
                    Pride Swallowed:{" "}
                  </Header>
            ...
            <Grid.Column>
              <Segment style={{ backgroundColor: "#5cdb95" }}>
                <Header as="h4">
                  My level of pettiness in this grudge:{" "}
                  <b>{this.props.grudge.pettyLevel}</b>
                </Header>
              </Segment>
              <div>
                <Button color="grey" onClick={this.open}>
                  Delete Grudge
                </Button>
                <Confirm
          ...
          <Grid.Row>
            <Grid.Column verticalAlign="middle">
              <Modal.Content>
                <Segment style={{ backgroundColor: "#5cdb95" }}>
                  <Header as="h4">Here is the misunderstanding: </Header>
                  <Container fluid text={true} textAlign="center">
            ...
            <Grid.Column verticalAlign="middle">
              <Modal.Content>
                <Segment style={{ backgroundColor: "#5cdb95" }}>
                  <Header as="h4">This grudge was resolved because: </Header>
                  <Container fluid text={true} textAlign="center">
                ...
                <Segment style={{ backgroundColor: "#5cdb95" }}>
                  <Header as="h4">
                    The best thing I can say about{this.props.grudge.enemyName}{" "}
                    is:{" "}
                  </Header>
                  <b style={{'color':'#db5ca2'}} className='insult'>{this.props.grudge.resolvedGrudges[0].compliment}</b>
